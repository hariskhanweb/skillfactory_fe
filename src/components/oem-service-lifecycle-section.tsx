      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Uniserved Solar Service Assurance Framework
          </h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            <span className="text-green-600 font-semibold">End-to-end</span> support
            across the lifecycle of your{" "}
            <span className="text-green-600 font-semibold">Solar Solution</span>.
            <br />
            Delivered through an{" "}
            <span className="text-green-600 font-semibold">AI-driven platform</span>{" "}
            and a{" "}
            <span className="text-green-600 font-semibold">connected solar ecosystem</span>.
          </p>
        </div>
